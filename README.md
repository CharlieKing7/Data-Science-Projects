...
5. __UD4_language_translation:__ In this project, I used generative adversarial networks to generate new images of faces. Click [here](https://nbviewer.jupyter.org/github/CharlieKing7/data-science-projects/blob/master/UD5_face_generation.ipynb) to see my work.
